...
char script_text[] = 
	 //SOCKS5 handshake
	"l 05 01 00"
	 //Server selects 'no authentication'
	"l 05 00"
	//Connect to [::1]:$p
	"l 05 01 00 04 00 00 00 00,00 00 00 00,00 00 00 00,00 00 00 01,    p"
	//Connection successful
	"l 05 00 00 04  k  k  k  k, k  k  k  k, k  k  k  k, k  k  k  k, k  k" 
	 //Test traffic...
	"l 01"
	"l 01 02"
;
...
int main()
{
	...
	//Open sockets
	test_open_listener("[::1]", &proxy_hd, &proxy_addr);
	test_open_listener("[::1]", &server_hd, &server_addr);
